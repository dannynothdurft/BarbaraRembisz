...
const services = [
  {
    ...
    description: "Gründliche Reinigung und Pflege des gesamten Innenraums für ein frisches Fahrgefühl.",
  },
  {
    icon: Droplets,
    title: "Lackaufbereitung & Politur",
    description: "Professionelle Lackpflege für dauerhaften Glanz und Schutz vor Umwelteinflüssen.",
  },
  {
    icon: Shield,
    title: "Keramikversiegelung",
    description: "Langanhaltender Schutz und brillanter Glanz durch hochwertige Keramikversiegelung.",
  },
  {
    icon: TrendingUp,
    title: "Fahrzeugaufbereitung für Verkauf",
    description: "Optimale Präsentation Ihres Fahrzeugs für einen erfolgreichen Verkauf.",
  },
]
  ...
  return (
    <section id="leistungen" className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-4 text-balance">Unsere Leistungen</h2>
