          ...
          <section className="bg-gradient-to-br from-zinc-900 to-zinc-800 border border-white/10 rounded-2xl p-8">
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <p>
                ...
                können Sie sich jederzeit an die oben genannte verantwortliche
                Stelle wenden.
              </p>
            </div>
          </section>
          ...
          <section className="bg-gradient-to-br from-zinc-900 to-zinc-800 border border-white/10 rounded-2xl p-8">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed">
              <div className="bg-white/5 rounded-lg p-6">
                ...
                <p>
                  Wir verwenden keine Analyse- oder Tracking-Tools auf dieser
                  Website. Es werden keine personenbezogenen Daten zu
                  statistischen oder Marketingzwecken erhoben, ausgewertet oder
                  an Dritte weitergegeben.
                </p>
                <div className="mt-3 text-sm">
                  <p>
                    <span className="text-white font-medium">Hinweis:</span>
                    Technisch notwendige Server-Logs (z. B. IP-Adresse,
                    Browsertyp, Datum und Uhrzeit des Zugriffs) können vom
                    Hosting-Anbieter zum Betrieb und zur Sicherheit der Website
                    verarbeitet werden. Diese Daten werden jedoch nicht zu
