  ...
  return (
    <section id="kundenstimmen" className="py-16 md:py-24 bg-secondary">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-4 text-balance">Kundenstimmen</h2>
          ...
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="border-2">
              <CardContent className="pt-6">
                ...
                <p className="text-foreground mb-4 text-pretty leading-relaxed">"{testimonial.text}"</p>
