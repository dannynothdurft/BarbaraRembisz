...
const services = [
  {
    ...
    description: 'Umfassende Rundum-Pflege für Ihr Fahrzeug - von der gründlichen Innenreinigung bis zur professionellen Außenaufbereitung. Perfekt für Generalüberholungen, Verkaufsvorbereitungen und Leasingrückgaben.',
    features: [
  ...
  },
  {
    ...
    description: 'Maschinelle Lackreinigung und hochwertige Politur mit Carnauba-Wachs für tiefen Glanz und langanhaltenden Schutz. Entfernt Kratzer, Hologramme und schützt vor Umwelteinflüssen.',
    features: [
  ...
  },
  {
    ...
    description: 'Gründliche Reinigung und Pflege des gesamten Innenraums. Von Teppichen über Polster bis zu allen Oberflächen - für ein frisches und gepflegtes Interieur.',
    features: [
  ...
  },
  {
    ...
    description: 'Spezielle Komplettaufbereitung für Reisemobile und Wohnwagen. Vom Fahrerhaus bis zum Wohnbereich - inklusive Möbelreinigung und Stoffverdeck-Pflege.',
    features: [
  ...
  },
  {
    ...
    description: 'Professionelle Motorraumreinigung für bessere Kühlleistung und Werterhalt. Inklusive Unterbodenpflege, Dichtungskontrolle und Korrosionsschutz.',
    features: [
    ...
    image: 'https://images.unsplash.com/photo-1622737133809-d95047b9e673?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
    details: ['Schonende Reinigung', 'Werterhalt', 'Professionell']
  },
  {
    icon: Brush,
    title: 'Felgen & Außenbereich',
    description: 'Intensive Reinigung und Pflege von Felgen, Radkästen, Außenkunststoffen, Reifen und Türdichtungen für ein perfektes Gesamterscheinungsbild.',
    features: [
  ...
  },
  {
    ...
    description: 'Individuelle Extras für besondere Anforderungen. Von der Haarentfernung bis zur Ozonbehandlung - wir lösen jedes Problem professionell.',
    features: [
...
const additionalServices = [
  {
    ...
    description: 'Bequemer Abholservice in Hamburg - wir kümmern uns um den Transport Ihres Fahrzeugs. Auf Anfrage in ganz Hamburg verfügbar.'
  },
  {
    icon: Zap,
    title: 'Express-Service',
    description: 'Schnelle Grundreinigung für zwischendurch - perfekt für spontane Termine und kurzfristige Aufbereitungen.'
  },
  {
    icon: CheckCircle,
    title: 'Leasing-Rückgabe',
    description: 'Professionelle Aufbereitung für die perfekte Leasingrückgabe ohne Beanstandungen. Ideal für Fahrzeugverkauf.'
  },
  {
    icon: Car,
    title: 'Cabrio-Spezial',
    description: 'Spezialreinigung und Pflege von Stoffverdecken bei Cabriolets. Schonende Behandlung für langanhaltenden Schutz.'
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed mb-8">
              ...
              Vom PKW bis zum Wohnmobil, von der Grundreinigung bis zur Premium-Politur
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:+4917662912411">
                <Button variant="outline" className="border-2 border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-[#00152a] font-semibold px-8 py-6 rounded-full text-lg transition-all duration-300 hover:scale-105">
                  Direkt anrufen
                </Button>
              </a>
            </div>
            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {service.details.map((detail, idx) => (
                            <span key={idx} className="bg-white/5 text-gray-300 px-3 py-1 rounded-full text-sm border border-white/10">
                              {detail}
                            </span>
                          ))}
                        </div>
                  ...
                  {/* Image */}
                  <div className={`relative h-[400px] rounded-2xl overflow-hidden group ${isEven ? '' : 'lg:col-start-1 lg:row-start-1'}`}>
                    <Image
                      src={service.image}
                      alt={service.title}
                      fill
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Rundum-Service für maximale Bequemlichkeit und individuelle Lösungen
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
              Jedes Fahrzeug ist einzigartig. Vereinbaren Sie eine kostenlose Vor-Ort-Begutachtung 
              für ein maßgeschneidertes Angebot ohne versteckte Kosten.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/kontakt">
                <Button className="bg-yellow-400 hover:bg-yellow-300 text-[#00152a] font-semibold px-8 py-6 rounded-full text-lg transition-all duration-300 hover:scale-105 shadow-lg">
