        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-balance">Termin vereinbaren</h1>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="innenraumreinigung">Innenraumreinigung</SelectItem>
                            <SelectItem value="lackaufbereitung">Lackaufbereitung & Politur</SelectItem>
                            <SelectItem value="keramikversiegelung">Keramikversiegelung</SelectItem>
                            <SelectItem value="verkaufsaufbereitung">Fahrzeugaufbereitung für Verkauf</SelectItem>
                            <SelectItem value="komplett">Komplettaufbereitung</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
            ...
            <div className="mt-8 text-center text-sm text-muted-foreground">
              <p>
                ...
                <a href="tel:+4917662912411" className="text-primary hover:underline font-medium">
                  0176 629 124 11
                </a>
              </p>
            </div>
